...
$(document).ready(function() {
  ...
  $.ajax({
    ...
    error: function() {
      $("#stations").html(
        window.i18n.photographer.errorLoadingStationsOfPhotographer +
          " " +
          photographer
      );
    },
        ...
        for (var i = 0; i < obj.length; i++) {
          ...
          $("#stations").append(
            '<div class="card mt-1" style="max-width: 302px;">' +
              ...
              window.i18n.photographer.licence +
              ': <a href="' +
              obj[i].licenseUrl +
              '">' +
              obj[i].license +
              ...
              '<a href="' +
              detailLink +
              '" data-ajax="false"><img src="' +
              photoURL +
              '" class="card-img-top" style="width:301px;" alt="' +
              obj[i].title +
              '"></a>' +
              "</div>"
          );
