...
<main role="main" class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content">
		...
		<form id="uploadForm" class="needs-validation" novalidate action="https://api.railway-stations.org/photoUpload" method="post" enctype="multipart/form-data" target="upload_target">
				...
				<div class="form-group missing-station">
						...
						<input name="stationTitle" type="text" class="form-control" id="inputStationTitle" placeholder="<?php echo $stationName; ?>" required>
				...
				<div class="form-group missing-station">
						...
						<input name="latitude" type="text" class="form-control" id="inputLatitude" placeholder="<?php echo $latitude; ?>" required>
						<div class="invalid-feedback">
				...
				<div class="form-group missing-station">
						...
						<input name="longitude" type="text" class="form-control" id="inputLongitude" placeholder="<?php echo $longitude; ?>" required>
						<div class="invalid-feedback">
				...
				<div class="form-group">
						...
						<input name="comment" type="text" class="form-control" id="inputComment" placeholder="<?php echo $commentInfo; ?>">
				</div>
				<div class="form-group">
				...
				<input id="uploadSubmit" type="submit" class="btn btn-primary mt-1" name="submitBtn" value="<?php echo $upload; ?>" disabled/>
		</form>
